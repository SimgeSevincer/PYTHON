# -*- coding: utf-8 -*-
"""
Created on Sun Dec 25 12:22:14 2022
...
#tarafından alınır.
# Aşağıdaki örnek için:  YazıTipiAkılsızDiyalog jpgsini inceleyerek aşağıdaki kodu anlayınız:
    
            
# Uygulamalarda kullanılacak temalar https://icons8.com/icons/set/python sitesinden alınmıştır.
...
"""
# Diyaloglar: 2.Akıllı Diyaloglar:
